...
<head>
	...
	<link rel="stylesheet" href="${APP_PATH}/script/theme/default/layer.css">
	<style>
		.tree li {
				...
				<div class="panel-body">
					<form role="form" id="form">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="role" placeholder="请输入角色名称">
						</div>
						<button type="button" class="btn btn-success" onclick="add()"><i class="glyphicon glyphicon-plus"></i> 新增</button>
						<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh" onclick="$('#form')[0].reset()"></i> 重置</button>
					</form>
				</div>
			</div>
		</div>
